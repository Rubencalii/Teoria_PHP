...
try {
    ...
    echo "<h2>A. Productos con bajo stock (menor a 40)</h2>";
    ...
    echo "<h2>B. Total de productos por categoria</h2>";
    ...
    echo "<h2>C. Valor total del inventario por categoria</h2>";
    ...
    echo "<h2>D. Precio promedio por categoria</h2>";
